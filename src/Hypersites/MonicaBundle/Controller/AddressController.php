...
use Hypersites\MonicaBundle\Entity\Address;
use Hypersites\MonicaBundle\Form\AddressType;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HypersitesMonicaBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("HypersitesMonicaBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HypersitesMonicaBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HypersitesMonicaBundle:Address:edit.html.twig")
     */
