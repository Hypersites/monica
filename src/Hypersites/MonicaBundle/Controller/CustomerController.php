...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HypersitesMonicaBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("HypersitesMonicaBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HypersitesMonicaBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HypersitesMonicaBundle:Customer:edit.html.twig")
     */
